        ...
        <aside class="sidebar">
            <div>
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="bi bi-heart"></i> Thú cưng</a></li>
                    <li><a href="#"><i class="bi bi-calendar-check"></i> Lịch hẹn</a></li>
                    <li><a href="#"><i class="bi bi-person-badge"></i> Bác sĩ</a></li>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    ...
                    if (!$pet) {
                        die("❌ Không tìm thấy thú cưng với ID: $id");
                    }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="../../../handle/pet_admin_process.php?action=edit" method="POST">
                                        <input type="hidden" name="id" value="<?= $pet['id'] ?>">

                                        <div class="form-group">
                                            <label>Tên thú cưng:</label>
                                            <input type="text" name="petname" class="form-control" value="<?= $pet['petname'] ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="petscol" class="form-control" value="<?= $pet['petscol'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="birth_date" class="form-control" value="<?= $pet['birth_date'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="customer_id" class="form-control" required>
                                                <?php foreach ($customers as $customer) { ?>
                                                    <option value="<?= $customer['idcustomers'] ?>"
                                                        <?= $pet['customer_id'] == $customer['idcustomers'] ? 'selected' : '' ?>>
                                        ...
                                        <div class="form-group">
                                            <label>Ghi chú:</label>
                                            <textarea name="note" class="form-control" rows="3"><?= $pet['note'] ?></textarea>
                                        </div>

                                        <button type="submit" class="btn btn-success mt-3">💾 Lưu thay đổi</button>
                                        <a href="../pet_admin.php" class="btn btn-secondary mt-3">⬅ Quay lại</a>
                                    </form>
                                </div>
                            </div>
                        </div>
