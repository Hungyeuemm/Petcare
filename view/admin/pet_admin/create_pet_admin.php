                ...
                <div class="content-box">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="../../../handle/pet_admin_process.php?action=create" method="POST">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select name="customer_id" class="form-select" required>
                                                    ...
                                                    <?php foreach ($customers as $cus): ?>
                                                        <option value="<?= $cus['idcustomers']; ?>">
                                                            <?= htmlspecialchars($cus['name_customer']); ?> (<?= htmlspecialchars($cus['idcustomers']); ?>)
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="species" class="form-control" placeholder="Chó, mèo, thỏ,...">
                                            </div>
                                            <div class="col-md-4">
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="text" name="petscol" class="form-control">
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <button type="submit" class="btn btn-success w-100">Thêm thú cưng</button>
                                    </form>
                                </div>
                            </div>
                        </div>
