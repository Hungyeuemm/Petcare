        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    <a href="./account_admin/create_account_admin.php" class="btn btn-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            require_once __DIR__ . '/../../handle/account_admin_process.php';
                            $accounts = handleGetAllAccounts();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href='./account_admin/edit_account_admin.php?id=<?= $account["id"] ?>'><i class="fa-solid fa-pen-nib fa-bounce" style="color: #B197FC;font-size: 1.2rem;"></i></a>
                                        <a href='../../handle/account_admin_process.php?action=delete&id=<?= $account["id"] ?>'
