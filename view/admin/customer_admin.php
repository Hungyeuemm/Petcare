        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    <a href="./customer_admin/create_customer.php" class="btn btn-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            require_once __DIR__ . '/../../handle/customer_admin_process.php';
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href='./customer_admin/edit_customer_admin.php?id=<?= $customer["idcustomers"] ?>'><i class="fa-solid fa-pen-nib fa-bounce" style="color: #B197FC;font-size: 1.2rem;"></i></a>
                                        <a href='../../handle/customer_admin_process.php?action=delete&id=<?= $customer["idcustomers"] ?>'
