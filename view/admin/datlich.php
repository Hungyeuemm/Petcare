<?php
// /view/admin/datlich_admin.php
session_start();
require_once __DIR__ . '/../../functions/auth.php';
require_once __DIR__ . '/../../functions/datlich_admin_functions.php'; // chỉ cần cái này thôi!
        ...
        <aside class="sidebar">
            <div>
                ...
                <ul>
                    ...
                    <li class="active"><a href="./datlich.php"><i class="bi bi-calendar-check"></i>Lịch hẹn</a></li>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    ...
                    <a href="./datlich_admin/create_dalich_admin.php" class="btn btn-primary">
