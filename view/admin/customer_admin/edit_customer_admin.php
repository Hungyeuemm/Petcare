        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    ...
                    if (!$customer) {
                        header("Location: ./customer_admin.php?error=Khách hàng không tồn tại");
                        exit();
                    }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="../../../handle/customer_admin_process.php" method="POST">
                                        <input type="hidden" name="action" value="edit">
                                        <input type="hidden" name="idcustomers" value="<?php echo htmlspecialchars($customer['idcustomers']); ?>">


                                        <div class="mb-3">
                                            <label for="user_id" class="form-label">Mã khách hàng</label>
                                            <input type="text" class="form-control" id="user_id" name="user_id"
                                                value="<?php echo htmlspecialchars($customer['user_id']); ?>" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="name_customer" class="form-label">Họ và tên</label>
                                            <input type="text" class="form-control" id="name_customer" name="name_customer"
                                                value="<?php echo htmlspecialchars($customer['name_customer']); ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone_customer" name="phone_customer"
                                                value="<?php echo htmlspecialchars($customer['phone_customer']); ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="email_customer" name="email_customer"
                                                value="<?php echo htmlspecialchars($customer['email_customer']); ?>" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <a href="../customer_admin.php" class="btn btn-secondary me-md-2">Hủy</a>
