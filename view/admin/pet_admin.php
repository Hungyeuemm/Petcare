...
require_once '../../functions/pet_admin_functions.php';
require_once '../../functions/customer_admin_functions.php';
        ...
        <div class="main-content">
            ...
            <main>
                <div class="content-box">
                    ...
                    <a href="./pet_admin/create_pet_admin.php" class="btn btn-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            require_once __DIR__ . '/../../handle/pet_admin_process.php';
                            $pets = handleGetAllPets();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $pet["note"] ?></td>
                                    <td>
                                        <a href='./pet_admin/edit_pet_admin.php?id=<?= $pet["id"] ?>'><i class="fa-solid fa-pen-nib fa-bounce" style="color: #B197FC;font-size: 1.2rem;"></i></a>
                                        <a href='../../handle/pet_admin_process.php?action=delete&id=<?= $pet["id"] ?>'
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa thú cưng này?')">
                                            <i class="fa-regular fa-trash-can fa-bounce" style="color: #e13737; font-size: 1.2rem;"></i>
                                        </a>
                                    </td>
                                </tr>
                            <?php } ?>
